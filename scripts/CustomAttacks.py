...
class TextFoolerJin2019(AttackRecipe):
    ...
    def build(model_wrapper):
        ...
        # Following https://arxiv.org/pdf/2004.14174.pdf
        # Setting Word Embedding Distance to be 0.9 and Sentence Embegging distance to be 0.98 to match human judgement
        ...
        #
        use_constraint = BERT(threshold=0.98,
        ...
        #
        goal_function = UntargetedClassification(model_wrapper, model_batch_size=128)
        #
